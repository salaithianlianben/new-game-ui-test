  ...
  >
    <style>
      {`.st0{fill:#FFFFFF;}
        ...
        .st2{clip-path:url(#clip0);fill:#FFFFFF;}`}
    </style>
    <path
      className="st0"
      d="M65.6,70c9.6,0,17.9-3.4,24.7-10.3c6.8-6.8,10.3-15.1,10.3-24.7c0-9.6-3.4-17.9-10.3-24.7
      C83.6,3.5,75.2,0,65.6,0C56,0,47.7,3.5,40.9,10.3S30.6,25.4,30.6,35c0,9.6,3.5,17.9,10.3,24.7C47.7,66.6,56,70,65.6,70z"
    />
    <polygon
      className="st1"
      points="118.5,150.5 118.5,124.5 96.5,124.5 96.5,115.5 118.5,115.5 118.5,91.5 128.5,91.5 128.5,115.5 
      150.5,115.5 150.5,124.5 128.5,124.5 128.5,150.5"
    />
    <defs>
      <clipPath id="clip0">
        <path d="M146,89.7c0-7.5-6.5-13.7-14.5-13.7h-15.1c-8,0-14.5,6.1-14.5,13.7V98h-8c-7.7,0-14,6.4-14,14.2v15.2
    ...
    <g clipPath="url(#clip0)">
      <path
        className="st2"
        d="M131.8,116c-0.2-2.9-0.6-6-1.3-9.3c-0.6-3.3-1.5-6.5-2.4-9.3c-1-3-2.4-5.9-4.1-8.7c-1.8-2.9-3.9-5.5-6.2-7.5
