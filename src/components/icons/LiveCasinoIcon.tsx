...
const LiveCasinoIcon: React.FC<IconProps> = (props) => {
  return (
    <svg
      viewBox="0 0 150 150"
    ...
    >
      <g>
        <path
          className="st0"
          d="M71.4,67.1c-1.1-4-4.2-7.1-8.2-8.2c-4-1.1-8.3,0-11.3,2.8l-3,3l-3-3c-3-2.9-7.3-4-11.3-2.9s-7.2,4.2-8.3,8.3
		c-1.1,4,0,8.3,2.9,11.3l0,0L47,96.2c1,1,2.5,1,3.5,0l17.8-17.8C71.5,75.4,72.5,71.1,71.4,67.1z"
        />
        <path
          className="st0"
          d="M27,33.9c0.5,1.3,1.9,1.9,3.2,1.4c1.3-0.5,1.9-1.9,1.4-3.2l-7.4-19.7c-0.4-0.9-1.3-1.6-2.3-1.6
        ...
        <path
          className="st0"
          d="M133,77.8c-10.3-7.6-23.7-9.8-35.9-5.8V8.4c0-2-0.8-3.8-2.2-5.2C93.6,1.8,91.7,1,89.7,1H8.3
        ...
        <path
          className="st0"
          d="M125.4,104.6c-0.8-2.9-3-5.1-5.9-5.9s-5.9,0.1-8,2.1l-1.2,1.2l-1.2-1.2c-1.5-1.6-3.7-2.5-5.9-2.5
        ...
        <path
          className="st0"
          d="M128.8,69.6l13.4-23.2c0.7-1.1,0.8-2.5,0.5-3.7c-0.3-1.3-1.2-2.3-2.3-3l-38.3-22.1v48.2
