// components/icons/AboutIcon.tsx
import React from 'react';

const SlotIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg
    version="1.1"
    id="Layer_1"
  ...
  >
    ...
    <polygon className="st0" points="74.8,0 83.7,18.3 103.9,21.2 89.4,35.4 92.8,55.6 74.8,46.1 56.7,55.6 60.1,35.4 45.6,21.2 65.8,18.3" />
    <polygon className="st0" points="25.1,19.1 31.4,32 45.6,34.1 35.4,44.1 37.8,58.2 25.1,51.6 12.3,58.2 14.7,44.1 4.5,34.1 18.8,32" />
    <polygon className="st0" points="124.8,19.1 131.1,32 145.3,34.1 135.1,44.1 137.6,58.2 124.8,51.6 112,58.2 114.4,44.1 104.3,34.1 118.5,32" />
    <path
      className="st0"
      d="M136.5,68H13.5C6.3,68,0.2,73.3,0,80.3v57.5c0.2,6.8,6.3,12.3,13.5,12.3h122.9c7.3,0,13.4-5.3,13.5-12.3V80.3 
