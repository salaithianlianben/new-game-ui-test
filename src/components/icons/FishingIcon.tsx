...
const FishingIcon :React.FC<IconProps>  = (props) => (
  <svg
    version="1.1"
    id="Layer_1"
  ...
  >
    ...
    <path className="st0" d="M19.4,127.3c-1.2-4.8-1.7-9.8-1.4-14.8c2,1.9,4.2,3.7,6.4,5.4c0.5,0.4,1,0.7,1.6,1.1
      C23.6,121.6,21.4,124.3,19.4,127.3z"/>
    <path className="st0" d="M107.3,87.7c-2.2-4.5-5.8-8.2-10.2-10.6c0.3-0.8,0.6-1.6,0.9-2.4c3,0.1,6.1,0,9.1-0.2h0.2
      C108,78.9,108,83.3,107.3,87.7z"/>
    <path className="st0" d="M51.5,12.3c-9.5,3.7-18.1,9.5-24.9,17c-0.7,0.8-1.4,1.6-2.1,2.4C20.8,19.9,14.4,9.1,6,0
      C34.4,2.5,46.7,8.7,51.5,12.3L51.5,12.3z"/>
    <path className="st0" d="M73.2,13.3C57,13.9,41.6,21,30.6,33c-1.6,1.8-3.1,3.6-4.5,5.6c-0.1,0.8-0.6,1.5-1.3,1.9
