...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-black py-1 px-2 text-muted-foreground w-full",
      className
    )}
    {...props}
  />
