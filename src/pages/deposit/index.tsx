  ...
  return (
    <div className='!bg-primary/10 px-10 pt-10 pb-32 h-full overflow-y-scroll'>
      <div className="flex items-center gap-4">
        <p className='basis-1/5'>Deposit To</p>
        <div className="flex flex-wrap gap-4 basis-4/5 ">
          {banks.map((item)=>{
      ...
      <div className="my-8 flex items-center gap-4">
       ...
       <div className="my-8 flex  gap-4">
        ...
        <div className="my-8 flex items-center gap-4">
        <p className='basis-1/5'>Receipt *</p>
        <div className="space-y-1  basis-4/5">
            <Input className='!w-full bg-primary/10 border border-primary !text-white !placeholder-white' type='file' />
        </div>
      </div>
